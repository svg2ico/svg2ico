...
The latest version of svg2ico available for download is https://sourceforge.net/projects/svg2ico/files/latest[{revnumber}]. The link:javadoc[javadoc] is also available online.
