...
import release.github.GitHub.ReleaseId
    ...
    fun `can release`() {
        ...
        val releaseOutcome = try {
            GitHubHttp(
                ...
                GitHubHttp.GitHubToken("not checked yet")
